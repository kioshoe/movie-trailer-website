...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .movie-caption {
            ...
            right: 0px;
            background: #57d65c;
            background: -webkit-linear-gradient(#57d65c, #c9ffcb);
            background: -o-linear-gradient(#57d65c, #c9ffcb);
            background: -moz-linear-gradient(#57d65c, #c9ffcb);
            background: linear-gradient(#57d65c, #c9ffcb);
            color: #FFFFFF;
            opacity: 0;
